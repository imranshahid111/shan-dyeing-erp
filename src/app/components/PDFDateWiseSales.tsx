...
const styles = StyleSheet.create({
  ...
  companyName: { fontSize: 18, fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: 0.8 },
  companyDetail: { fontSize: 9, color: '#333', marginTop: 2 },
  titleBlock: { alignItems: 'flex-end' },
  reportTitle: { fontSize: 15, fontWeight: 'bold', textTransform: 'uppercase' },
  ...
  tableRow: { flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: BORDER, minHeight: 18 },
  ...
  cellLast: { padding: 4.5, fontSize: 9, textAlign: 'right' },
