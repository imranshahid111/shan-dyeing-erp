...
const styles = StyleSheet.create({
  ...
  companyName: { fontSize: 16, fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: 0.6 },
  companyDetail: { fontSize: 9, color: '#333', marginTop: 1 },
  reportTitle: { fontSize: 14, fontWeight: 'bold', textTransform: 'uppercase' },
  ...
  tableRow: { flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: BORDER, minHeight: 15 },
  ...
  cellLast: { padding: 2.5, fontSize: 7.5, textAlign: 'center' },
