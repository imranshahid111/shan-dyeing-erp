    ...
    <View style={styles.copy}>
      ...
      <View style={styles.table}>
        <View style={[styles.tableRow, styles.tableHeader]}>
          ...
          <Text style={[styles.tableCellLeft, { width: '18%' }]}>Party Name</Text>
          <Text style={[styles.tableCellLeft, { width: '15%' }]}>Description</Text>
          <Text style={[styles.tableCell, { width: '10%' }]}>Deliver At</Text>
        ...
        {(gp.items || []).map((item, idx) => (
          <View style={styles.tableRow} key={idx}>
            ...
            <Text style={[styles.tableCellLeft, { width: '18%' }]}>{item.delivery_order?.customer?.name || '—'}</Text>
            <Text style={[styles.tableCellLeft, { width: '15%' }]}>{item.description || '—'}</Text>
        ...
        <View style={[styles.tableRow, styles.totalRow]}>
          ...
          <Text style={[styles.tableCellLeft, { width: '18%' }]}></Text>
          <Text style={[styles.tableCellLeft, { width: '15%' }]}></Text>
          <Text style={[styles.tableCell, { width: '10%' }]}></Text>
