module.exports = (sequelize, DataTypes) =>
  sequelize.define(
    "delivery_orders",
    {
      ...
      total_gray_gazana: { type: DataTypes.DECIMAL(14, 4), allowNull: false, defaultValue: 0 },
      total_ready_gazana: { type: DataTypes.DECIMAL(14, 4), allowNull: false, defaultValue: 0 },
      kinar_cut_amount: { type: DataTypes.DECIMAL(12, 2), allowNull: false, defaultValue: 0 },
      kinar_cut_qty: { type: DataTypes.DECIMAL(14, 4), allowNull: true },
      packing_amount: { type: DataTypes.DECIMAL(12, 2), allowNull: false, defaultValue: 0 },
      packing_qty: { type: DataTypes.DECIMAL(14, 4), allowNull: true },
